...
{
    private const string SerializedDropBoxCredential = "{\"RefreshToken\":\"refresh\",\"AppKey\":\"key\",\"AppSecret\":\"secret\",\"Folder\":\"folder\"}";
    ...
    {
        Assert.That(DropboxSecret.GetSerializedContent(_dropboxSecretObject), Is.EqualTo(SerializedDropBoxCredential));
    }
}