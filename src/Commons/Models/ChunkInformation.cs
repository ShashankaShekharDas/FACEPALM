...
public class ChunkInformation(string fileName, int chunkNumber, int totalChunks, EncryptionType encryption) : BaseDatabaseModels
{
    ...
    public static BaseDatabaseModels Deserialize(NpgsqlDataReader reader)
    {
